...
export function seedOutlinePrompts(entry: CatalogEntry): {
  ...
  return {
    ...
    prompt: [
      ...
      "",
      "Rules:",
      "- 5-8 stages, each with 3-8 topics; mark topics OPTIONAL when reasonable people skip them.",
      ...
      "- Each topic gets 0-4 subtopics; keep subtopics for genuinely separable sub-skills.",
      "",
...
export function resourcePrompts({
  ...
  return {
    ...
    prompt: [
      ...
      '{"resources":[{"kind":"article|video|docs|course|book","title":str,"url":str,"is_paid":false}]}',
